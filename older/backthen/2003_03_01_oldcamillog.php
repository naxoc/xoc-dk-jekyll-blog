...
have been getting is when I lift a chair from one room into
the other room where the computer is. I have been dancing
though, and that is real good fun, but you don't really work
up a sweat doing that. </p>
<p>
Now I have decided to play handball again in the Copenhagen
gay sports club PAN-idr&aelig;t. For those of you (that would be
the Americans) that don't know this fine sport, I can
explain that it is a lot like soccer, except it's indoors,
the field is smaller and you can take the ball up in your
hand - OK. It's not at all like soccer. Maybe the picture of
the game explains it better. 
I should probably also say that the game does not give extra
points for taking the opponents shirts of.  </p>
<p>
Anyway, I played this Tuesday and my arm has felt like it's
about to fall of ever since. I hereby promise myself that I
will never go without exercise for that long again.
...
href="http://www.verture.net">Jonas</a>. Apparently the
people at The National Cattlemen's Beef Association are
worried that a lot of young girls are vegetarians. Of course
that is not good for sales so they came up with <a href="http://www.cool-2b-real.com/">
a dead cool website</a>
to encourage girls to be real girls (and eat beef of
course). </p>
<p>
I wonder if they considered targeting the large number of
lesbians that are vegetarians. In that case I would advise a
slight modification of the site.  
</p>
...
<p class="useit">
  <b>Comment movers inc.</b><br />
Phew! What a job copying all my comments into my own
database! I'm almost done now and it's really boring work,
but the reward is that I, and only I, have complete control
over the little bastards. If any of you out there need a
free commenting system and you have an afternoon to kill
installing it (its PHP and MySQL) and moving old comments,
do send me an <a href="mailto:camilla(a)xoc.dk">email</a>.
</p>
...
<p class="useit">
  While I am copying the old comments to my new commenting system I have removed them from this site, but I guess it's no loss, since they never showed up here anyway. </p>
<p>
...
fuss about <a
href="http://film.guardian.co.uk/news/story/0,12589,898020,00.html">some
pictures taken at Catherine Zeta-Jones' and Michael Douglas' wedding</a> in
2000. The couple had sold the rights to photograph at the wedding to a magazine
that had sold the pictures to other magazines, including a Danish one, without the 
right to do so. </p>
<p>
Now it turns out that Michael and Catherine are furious that the pictures ended
up in a Danish porno-magazine called "Se og Hor". Here the good part starts,
because the magazine is really called "Se og H&oslash;r" which means "See and
listen" in Danish, but because Americans don't have "&oslash;"s they translated
"hor" without the slash which means something like adultery or just plain
"fuck". That would make the magazines name "see and fuck". The magazine is, although tabloid, not a porno magazine.. I think it
takes a little more explicit pictures to qualify as porn.
...
Java and we were talking about a method called clone() - a method that makes 
an exact copy of any object. As my thoughts wandered I realized that no one 
had really considered what happens when you clone human objects for instance. 
What if I had a George Bush object from my dictator class? Would I really want 
to clone that? <br />
I suddenly have my doubts about object-oriented programming. Has any one really 
discussed the ethics of using clone()?
</p>
...
href="http://www.wage-slave.org/scorecard.html">George Bush scorecard of
evil</a> really confirms your every suspicion about that guy.
