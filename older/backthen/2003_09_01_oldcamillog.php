...
<p class="useit">
  <b>Gay robots? Of course..</b><br />
Today I am not lucky trying to connect to my schools server. So, since there isn't really much for me to do other than sit here and wait for the goddam server to be up 
again, I might as well drop some more links on my weblog. I found a site that has a list of <a href="http://home.globalcrossing.net/~variable/gayrobot.html">gay robots</a>. Once you think about it it's obvious. Who can honestly say that C3PO does not have a touch of gay?
</p>
...
<p class="useit">
  <b>I will be famous in deep space!</b><br />
How very strange. Apparently there is a site where you can enter your name, have it put in a database and when some space vehicle encounters the comet Tempel 1, 
it will bring your name stored on a disk. I wonder about a few points:<br />
&bull; Who will it deliver the disk to?<br />
&bull; Should it be saved in a DOS or UNIX format?<br />
&bull; Since it says on the website that one should avoid using foreign (non-English) characters, can one then safely assume that aliens only speak English?<br />
<br />
If you want your name sent to a comet along with my name,  go <a href="http://deepimpact.jpl.nasa.gov/sendyourname/index.html">put your name there</a>.
</p>
...
<p class="useit">
  <b>How to make french fries</b><br />
<a href="http://www.weebls-stuff.com/toons/17/">This</a> is very weird and funny little animated cartoon.
</p>
...
<p class="useit">
  <b> I think i'm off weblogging</b><br />
As you may have noticed this weblog is not really being updated any more. I don't really feel like posting anymore and i'm also a bit too busy to say the least. 
Also, Blogger decided to change the post ids to the worlds longest integer for each post. That broke my commenting system, and although I found a way to fix it, I really don't feel like updating my database because thats hell. </p>
<p>
